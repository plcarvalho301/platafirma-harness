...
```
confundimento-de-ambiente-em-avaliacaodegradacao-diferencial-sob-compressao
interacao-tardia               isolamento-de-contexto-por-delegacao
mediacao-do-loop-agentico      quando-cabe-um-agente
ranqueamento-multiestagio      recuperacao-densa
relevancia-graduada            transporte-de-estado-entre-sessoes
```
