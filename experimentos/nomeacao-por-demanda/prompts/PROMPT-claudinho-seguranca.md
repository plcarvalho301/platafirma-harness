...
```
acesso-delegado                autoridade-do-intermediario
avaliacao-de-conformidade      avaliacao-de-impacto-a-privacidade
base-legal-de-tratamento       comunicacao-de-incidente-ao-titular
controlador-e-operador         credenciamento-de-seguranca
criptoperiodo                  dano-sem-vazamento
exercicio-adversarial          exercicio-de-plano
janela-de-exposicao            linha-de-base-de-controles
modulo-criptografico           necessidade-de-conhecer
negar-por-padrao               politica-de-seguranca-institucional
prova-de-identidade            regras-de-engajamento
requisito-verificavel          token-portador
transparencia-de-composicao    valor-de-fabrica
vida-util-do-sigilo
```
