...
```
affordance                     avaliacao-heuristica
design-centrado-no-humano      entrevista-por-comportamento-passado
esquema-de-organizacao         fatiamento-por-jornada
gap-desenho-realidade          resultado-sobre-entrega
riscos-de-produto              teste-de-usabilidade-informal
```
