...
```
cadeia-de-resultados           entrega-vs-resultado
erro-de-tipo-tres              estruturacao-de-problema
gestao-estrategica             governanca-publica
isomorfismo-institucional      pacto-de-entrega
problema-perverso              teto-de-compromisso
```
