...
record). Recorte por chapéu vai no `ferramental.md` de cada chapéu.
...
ora mora em `em_vez_de` (eixo de anti-padrao), por falta de eixo de alias-de-verbo no
schema -- a saida ainda rotula "anti-padrao". Eixo proprio proposto ao dono (DDL, TI);
quando entrar, o alias migra e o rotulo corrige.
