...
Para cada uma das **20** perguntas, diga **qual obra do acervo deveria responder**.

São 20 e não 10 de propósito: dez são as suas, e dez vieram de uma coleta externa em
fonte aberta cujo recorte cai dentro do seu domínio. Decisão do dono — elas entram no
gabarito como extensão da sua cadeira. As dez de fora vêm em anexo:

```
/home/claudinho/AI/gold-set/fase-b/anexo-osint-10.md
```

Casa as vinte pelo mesmo critério. Não reordene e não misture as duas listas: responda
1–10 (suas) e 11–20 (anexo).
...
Vinte linhas, mais uma no fim com a contagem de `nenhuma`. Título exato porque o
...
`fila/claudinha-gestao-estrategica/<AAAAMMDDThhmmss>-claudinho-conhecimento.md`, tipo `resposta`, com
