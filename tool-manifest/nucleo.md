Substitui: tool-manifest/TODA-CADEIRA.md (2026-08-16)

Peça de abertura. O que sai daqui e vira leitura por ato está em
`platafirma-arquitetura/docs/administrativo.md` — norma de card, execução inteira
e teste de admissão da fila. **Ler antes de abrir card, antes de decidir se um
trabalho vai inteiro, e antes de mandar mensagem.**
