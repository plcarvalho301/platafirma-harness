...
- Contrato, armadilha e o porquê de cada um: `tool-manifest/nucleo-detalhe.md`, por ato.
...
conferir servico|verbo|skill|repo|peca|sessao|procedencia|superficie|commit
