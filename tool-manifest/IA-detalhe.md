# tool_manifest — claudinho-IA · DETALHE (por ato)

> Índice de abertura: `tool-manifest/IA.md`. Este arquivo NÃO sobe na abertura —
> lê-se por ato, quando o contrato, a versão ou a prova de um item importa.
